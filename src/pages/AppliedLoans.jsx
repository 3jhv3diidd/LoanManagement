...
const AppliedLoans = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:8080/api/loan-applications/all")
      .then(res => {
                ...
                {app.approval_Status === 'PENDING' && (
                  <div className="applied-loans-actions">
                    <button
                      ...
                      onClick={async () => {
                        try {
                          await axios.post(`http://localhost:8080/api/loan-applications/${app.application_id}/decision`, { approved: true });
                    ...
                    <button
                      ...
                      onClick={async () => {
                        try {
                          await axios.post(`http://localhost:8080/api/loan-applications/${app.application_id}/decision`, { approved: false });
